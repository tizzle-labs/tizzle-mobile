...
export default function AccountSettingsScreen() {
  ...
  return (
    <View style={[s.container, { paddingTop: insets.top + Spacing.sm }]}>
      ...
      <View style={s.body}>
        <Ionicons name="person-circle-outline" size={48} color={Colors.text3} />
        <Text style={s.emptyTitle}>Coming Soon</Text>
        {/* TODO: Implement account settings — email, linked accounts, privacy */}
        <Text style={s.emptyBody}>Account settings will appear here.</Text>
      </View>
    </View>
  )
}
