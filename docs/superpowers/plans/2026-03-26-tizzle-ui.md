# Tizzle Ticket UI Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Replace the Solana boilerplate with a complete Tizzle Ticket mobile UI — fan ticketing (Explore → Event Detail → Buy Ticket → My Tickets → QR), organizer event creation (Create tab), and venue scanner (Scanner tab) — following the Editorial/Brutalist design system.
...
cp target/idl/tizzle_program.json /path/to/tizzle-ticket/lib/solana/idl.json
cd /path/to/tizzle-ticket
```
  ...
  "expo": {
    ...
    "plugins": [
      [
        "expo-camera",
        {
          "cameraPermission": "Tizzle Ticket needs camera access to scan ticket QR codes."
        }
      ]
    ]
  }
